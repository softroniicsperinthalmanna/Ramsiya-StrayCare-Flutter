...
class ViewAbuseCase extends StatefulWidget {
  const ViewAbuseCase({Key? key}) : super(key: key);

  @override
  State<ViewAbuseCase> createState() => _ViewAbuseCaseState();
}

class _ViewAbuseCaseState extends State<ViewAbuseCase> {
  var flag;
  var _selectedItem;

  Future<dynamic> getData() async {
    var response = await get(Uri.parse('${Con.url}viewAbuseCase.php'));
    print(response.body);
