...
class ViewAggressiveCase extends StatefulWidget {
  const ViewAggressiveCase({Key? key}) : super(key: key);

  @override
  State<ViewAggressiveCase> createState() => _ViewAggressiveCaseState();
}

class _ViewAggressiveCaseState extends State<ViewAggressiveCase> {
  var flag;
  var _selectedItem;

  Future<dynamic> getData() async {
    var response = await get(Uri.parse('${Con.url}viewAggressiveCase.php'));
    print(response.body);
