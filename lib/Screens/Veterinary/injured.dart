...
class ViewInjuredCase extends StatefulWidget {
  const ViewInjuredCase({Key? key}) : super(key: key);

  @override
  State<ViewInjuredCase> createState() => _ViewInjuredCaseState();
}

class _ViewInjuredCaseState extends State<ViewInjuredCase> {
  var flag, available;
  var _selectedItem;
  var callList;
  Future<dynamic> getPhoneNo() async {
    ...
    if (res2 == "success") {
      available = 1;
      callList = jsonDecode(response.body);
    } else {
      available = 0;
    }
  ...
  Future<dynamic> getData() async {
    var response = await get(Uri.parse('${Con.url}viewInjuredCase.php'));
    print(response.body);
    var res2 = jsonDecode(response.body)[0]['result'];
    print('result is : $res2');
        ...
        child: Container(
          ...
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                print('Inside vet case card: ${snapshot.hasData}');
                if (!snapshot.hasData) {
                  return const Center(
                    child: Text('No Data..'),
                  );
                                                              ...
                                                              child: ListView
                                                                  .builder(
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return ListTile(
                                                                          title:
                                                                              Text(callList[index]['location']),
                                                                          subtitle:
                                                                              Text(callList[index]['phone']),
                                                                          onTap:
                                                                              () {
                                                                            showDialog(
                                                                                context: context,
                                                                                builder: (context) {
                                                                                  return AlertDialog(
                                                                                    ...
                                                                                    actions: [
                                                                                      TextButton(
                                                                                          onPressed: () {
                                                                                            Uri launchUri = Uri(scheme: 'tel', path: callList[index]['phone']);
                                                                                            launchUrl(launchUri);
                                                                                            Navigator.pop(context);
                                                                                          },
                                                                                          child: Text('sure')),
